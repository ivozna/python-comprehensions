from comprehensions.comprehensions import count_spaces, count_vowels, divisible, eight_div, five_letters, have_six, highest, plus, word_length
...
def test_count_spaces():
    assert count_spaces(
        "Find all of the numbers from 1 to 1000 that have a 6 in them") == 14
...
def test_word_length():
    assert word_length("Practice Problems to Drill") == {
        "Problems": 8,
        "to": 2,
        "Drill": 5,
        "Practice": 8
